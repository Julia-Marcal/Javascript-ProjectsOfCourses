class ValidaFormulario {
  ...
  handleSubmit(e) {
    e.preventDefault();
    //para que o formulario não seja enviado automaticamente
    const camposValidos = this.camposSaoValidos();
    const senhasValidas = this.senhasSaoValidas();

    //caso o formulário não tenha erros
  ...
  camposSaoValidos() {
    ...
    for(let errorText of this.formulario.querySelectorAll('.error-text')) {
      errorText.remove();
      //remove as mensagens de erro dps do envio do formulario 
    }

    for(let campo of this.formulario.querySelectorAll('.validar')) {
      const label = campo.previousElementSibling.innerText;
      //diz o nome do elemento q deu erro
  ...
  criaErro(campo, msg) {
    ...
    //adiciona um elemento após o fim do elemento que deu erro
  }
}
